  ...
  return (
    <div className="max-w-3xl mx-auto p-4 flex flex-col gap-4">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to My Daily Notes.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to My Daily Notes, accessible from{' '}
            <a
              href="https://einburgerung.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://einburgerung.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        by email at{' '}
        <a href="mailto:bisheshtiwaree@gmail.com">bisheshtiwaree@gmail.com</a>
      </p>
    </div>
  );
};
